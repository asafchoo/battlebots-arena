              ...
              >
                ...
                {winner?.image_url && (
                  <img
                    ...
                    alt={winner.name}
                    className="w-48 h-48 rounded-full object-cover border-4 border-yellow-400 shadow-[0_0_60px_rgba(250,204,21,0.7)]"
                  />
                )}
                ...
                <div className="flex flex-col items-center gap-4">
                  {bot1?.image_url && (
                    <img
                      src={bot1.image_url}
                      alt={bot1.name}
                      className="w-48 h-48 rounded-full object-cover border-4 border-cyan-500/60 shadow-[0_0_40px_rgba(6,182,212,0.4)]"
                    />
                  )}
                ...
                >
                  {bot1?.image_url && (
                    <img
                      src={bot1.image_url}
                      alt={bot1.name}
                      className="w-52 h-52 rounded-full object-cover border-4 border-cyan-400 shadow-[0_0_50px_rgba(6,182,212,0.6)]"
                    />
                  )}
                ...
                >
                  {bot2?.image_url && (
                    <img
                      src={bot2.image_url}
                      alt={bot2.name}
                      className="w-52 h-52 rounded-full object-cover border-4 border-purple-400 shadow-[0_0_50px_rgba(168,85,247,0.6)]"
                    />
                  )}
                  <div className="text-white text-5xl font-black uppercase tracking-tight drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]">
                    {bot2?.name || "TBD"}
